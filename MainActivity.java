...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Welcome to ArogyA", Snackbar.LENGTH_LONG)
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            fragmentManager.beginTransaction().replace(R.id.content_frame,new DiseaseFragment()).commit();
            ...
            fragmentManager.beginTransaction().replace(R.id.content_frame, new BloodFragment()).commit();
